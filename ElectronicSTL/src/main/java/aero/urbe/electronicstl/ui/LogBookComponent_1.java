...
//import aero.urbe.electronicstl.MyClasses.MyStepperInterface;
...
//}
//
//class NewPage extends Window implements Property.ValueChangeListener, MyStepperInterface, Button.ClickListener {
//    
...
//        actualTtl = String.valueOf(array.get(3));
//        vl.removeAllComponents();
//        //Date page
...
//        ttlEnd = new MyStepper();
//        ttlEnd.setListener(this);
//        ttlEnd.setCaption(Messages.END);
//        ttlEnd.setWidth("100%");
//        ttlTotal = buildTextField(Messages.ACTUAL_TTL_AFTER_SESSION);
//        ttlTotal.setValue(Messages.ERROR);
//        ttlStart.setValue(String.valueOf(actualTtl));
//        ttlEnd.setValue(Double.valueOf(actualTtl));
//        ttlTotal.setValue(Messages.ERROR);
...
//    @Override
//    public void change() {
//        if(Double.valueOf(ttlEnd.getValue()) <= Double.valueOf(ttlStart.getValue())) {
//            ttlTotal.setValue(Messages.ERROR);    
//        } else {
//            Double total = Double.valueOf(ttlStart.getValue()) + Double.valueOf(ttlEnd.getValue());
//            String result = String.format("%.1f", total);
//            ttlTotal.setValue(result);
//        }
//    }
//
//    @Override
...
//                if(ttl > 0) {
//                    if(scheduledTotal.getValue().equals(Messages.ERROR) || actualTotal.getValue().equals(Messages.ERROR) || ttlTotal.getValue().equals(Messages.ERROR) || dev1.getValue().equals("")) {
...
//                stlPage.put("ttl_start", ttl > 0 ? ttlStart.getValue() : "0");
//                stlPage.put("ttl_end", ttl > 0 ? ttlEnd.getValue() : "0");
//                stlPage.put("ttl_total", ttl > 0 ? ttlTotal.getValue() : "0");
